...
namespace ConsoleApp1
{
    ...
    public static class ServiceProviderManager<T> where T : ServiceProviderBase
    {
        ...
        {
            var test = ConfigurationManager.GetSection("EmployeeService");
            ServiceConfig = (DataProviderConfigurationSection)ConfigurationManager.GetSection("EmployeeService");
